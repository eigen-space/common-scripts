...
const localBranchInintoMaster = /Merge branch '.+'$/g;
const remoteBranchInintoMaster = /Merge remote-tracking branch '.+'$/g;
...
const intoMaster = [localBranchInintoMaster, remoteBranchInintoMaster, pullRequestintoMaster];
